...
var ChatBotPane = React.createClass({
  render: function() {
    return (
        <div id="chat-pane" className="column">
          <h1>Chat Panel</h1>
          <iframe id='chat-window' src='https://webchat.botframework.com/embed/PhoneOrderBot?s=xFeBli_ZOVo.cwA.MyA.Dby9bMKpibVGnRDTgZWhZz_57Eud488ms1W74pqu0xg'></iframe>
        </div>
    )
  }
});
    ...
    return (
      <div className="store">
        ...
        <div className="orders">
          <div><i className="fa fa-shopping-cart" aria-hidden="true"></i> {this.getCount("Confirmed")}</div>
          <div><i className="fa fa-truck" aria-hidden="true"></i> {this.getCount("Shipping")}</div>
